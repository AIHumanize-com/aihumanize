...
ARG USER=user
ARG USER_UID=1001
ARG PROJECT_NAME=humanizer_app
...
ARG DJANGO_SUPERUSER_USERNAME=chako
ARG DJANGO_SUPERUSER_PASSWORD=#Ashabdulla17012018
ARG DJANGO_SUPERUSER_EMAIL=aabdurazzoqov1996@gmail.com
